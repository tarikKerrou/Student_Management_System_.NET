            ...
            public int age {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("La valeur pour la colonne \'age\' dans la table \'Student\' est DBNull.", e);
                    }
                }
                set {
...
namespace GestionEtudiant.DSTableAdapters {
...
SELECT Id, name, age FROM Student WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::GestionEtudiant.Properties.Settings.Default.mabaseConnectionString;
        }
